...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.b0cac5af303bb2a37b2fb1258d171ead755cd3d1d756074126d5cc0a61d1c897.js',function(){input.required=false;search();});}
