...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.d31b544125214fdbf5a586a10ac6bbd786b13434605c2314f6ee42dd50a0795d.js',function(){input.required=false;search();});}
