...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.33e0479095d80357a5a4e8628d261db22db94042e293fd17b4f9fb31b40ef08a.js',function(){input.required=false;search();});}
