...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.86d50361a8d604bf0da36f8f0ecbc78a9fdc703a17432141a18f0916e528e95d.js',function(){input.required=false;search();});}
