...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d64432567411a3653600d6e7f676587ccf5899b82408741e0b7de433c732ada4.js',function(){input.required=false;search();});}
