...
`}),e.add({id:28,href:"/study-python/docs/basic/other/package/",title:"Package",section:"1.4 其他",content:" Package # "}),e.add({id:29,href:"/study-python/docs/advanced/prof/",title:"2.6 性能",section:"第二部分 进阶实战",content:" Python 性能 # cProfile # VizTracer # gaogaotiantian/viztracer "}),e.add({id:30,href:"/study-python/docs/basic/other/anaconda/",title:"Anaconda",section:"1.4 其他",content:` Anaconda # Anaconda 是一个免费开源 的 Python 和 R 语言的发行版本，用于计算科学（数据科学、机器学习、大数据处理和预测分析），Anaconda 致力于简化包管理和部署。
