...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.6207a5b548a01e5ac9e693533309a7deaf3debf77e86a9df27e7d8ee4a3d82c7.js',function(){input.required=false;search();});}
