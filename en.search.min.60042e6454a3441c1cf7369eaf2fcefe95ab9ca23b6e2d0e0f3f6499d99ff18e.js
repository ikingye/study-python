...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.f438cad032362a9f3573522729de0a2b82c4647c3618c0f21599bc8db38e7122.js',function(){input.required=false;search();});}
