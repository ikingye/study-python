...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.8efd3261bf73da3b470ee0faf12fa1965c9aa515a1fd640a2486c47dba5172b5.js',function(){input.required=false;search();});}
