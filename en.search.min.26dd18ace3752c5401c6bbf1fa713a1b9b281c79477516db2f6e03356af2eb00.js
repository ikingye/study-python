...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.bcc9caa4f77d2ed8e24b0d947ebd5bd2352698ae5bca7dd2a79a011f1be390d4.js',function(){input.required=false;search();});}
