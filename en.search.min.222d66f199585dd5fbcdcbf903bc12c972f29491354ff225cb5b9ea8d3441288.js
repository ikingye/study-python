...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.27e7eda43cb10fe976002354409c07b65e26c558d6acae777c8dc83451a7be1d.js',function(){input.required=false;search();});}
