...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-python/flexsearch.min.js');loadScript('/study-python/en.search-data.min.1a3de6124a748c2c27776fa8ebfb75c0890e0d083c6a8a312d2a632d974dfcb7.js',function(){input.required=false;search();});}
